    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-white px-6">
        <div className="text-center space-y-3">
          <p className="text-slate-500 text-sm">Invalid reset link.</p>
      ...
      <div className="flex-1 flex flex-col justify-center items-center bg-white px-6 py-12">
        ...
        <div className="w-full max-w-sm space-y-7">
          <div>
            ...
            <p className="text-sm text-slate-500 mt-1">Your new password must be different from your old one.</p>
          </div>
