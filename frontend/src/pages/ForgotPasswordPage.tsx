    ...
    <div className="min-h-screen flex font-sans">
      ...
      <div className="flex-1 flex flex-col justify-center items-center bg-white dark:bg-slate-950 px-6 py-12">
        ...
        <div className="w-full max-w-sm space-y-7">
          {sent ? (
            <div className="space-y-4">
              <div className="w-12 h-12 rounded-full bg-green-50 dark:bg-emerald-950/30 border border-green-200 dark:border-emerald-800 flex items-center justify-center">
                <svg className="w-6 h-6 text-green-600 dark:text-emerald-400" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                  <path strokeLinecap="round" strokeLinejoin="round" d="M5 13l4 4L19 7" />
                </svg>
              </div>
              <div>
                <h1 className="text-2xl font-bold text-slate-900 dark:text-slate-100 tracking-tight">Check your email</h1>
              ...
              <Link
                to="/login"
                className="block text-center text-sm text-brand-600 hover:text-brand-700 dark:hover:text-brand-400 font-medium"
              >
                ← Back to sign in
              </Link>
            </div>
            ...
            <>
              <div>
                <h1 className="text-2xl font-bold text-slate-900 dark:text-slate-100 tracking-tight">Reset your password</h1>
